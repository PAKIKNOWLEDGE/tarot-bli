...
- **全部 78 张牌**：22 张大阿尔卡纳（原版插画）+ 56 张小阿尔卡纳
  - 原帖仅提供 4 张小阿尔卡纳 ACE 花色图，其余 52 张牌面由 SVG 程序化生成：
    数字牌（2–10）以原版立绘为中央画面 + 经典点阵排布花色符号；宫廷牌（侍从/骑士/王后/国王）为立绘 + 王冠徽章
...
images/             幻星集塔罗卡面插画（22 大 + 4 小 + 卡背）
build_single.py     单文件版打包脚本
幻星集塔罗.html      单文件版（构建产物）
```

## 素材来源

卡面插画来自 [bilibili · 幻星集塔罗](https://www.bilibili.com/opus/441785769200577976)，版权归原作者所有，此处仅作学习欣赏用途。
